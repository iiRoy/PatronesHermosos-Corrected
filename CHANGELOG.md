...
* feat(api): agregar implementación de 27 endpoints para gestión de mentors, groups, collaborators y v ([97d4306](https://github.com/iiRoy/Patrones-Hermosos/commit/97d4306))
* feat(merge): Merge from diego_sqlProcedures to main ([d3d9e6a](https://github.com/iiRoy/Patrones-Hermosos/commit/d3d9e6a))
* feat(participants): Implementar CRUD completo, tabla personalizada y actualización de datos básicos ([785a17c](https://github.com/iiRoy/Patrones-Hermosos/commit/785a17c))
* feat(status): crear controlador y ruta GET para obtener el estado de entidad por ID, con mapeo de va ([d452926](https://github.com/iiRoy/Patrones-Hermosos/commit/d452926))
* feature(mysql): Procedimiento desactivar_colaborador funcional ([90925b6](https://github.com/iiRoy/Patrones-Hermosos/commit/90925b6))
* feature(mysql): Procedimiento eliminar_venue funcional ([989acb0](https://github.com/iiRoy/Patrones-Hermosos/commit/989acb0))
* feature(mysql): Se agrego y se testeo metodo cambiar_estado_colaborador funcional ([b463497](https://github.com/iiRoy/Patrones-Hermosos/commit/b463497))
* feature(mysql): Se agrego y se testeo metodo cambiar_estado_grupo funcional ([c308724](https://github.com/iiRoy/Patrones-Hermosos/commit/c308724))
* feature(mysql): Se agrego y se testeo metodo cambiar_estado_participant funcional ([d1360be](https://github.com/iiRoy/Patrones-Hermosos/commit/d1360be))
* feature(mysql): Se agrego y se testeo metodo desactivar_grupo funcional y se corrigió una linea al l ([4815e3c](https://github.com/iiRoy/Patrones-Hermosos/commit/4815e3c))
* feature(mysql): Se agrego y se testeo metodo desactivar_venue funcional ([8bcdd97](https://github.com/iiRoy/Patrones-Hermosos/commit/8bcdd97))
* feature(sql): Procedimiento eliminar_grupo funcional ([6f62add](https://github.com/iiRoy/Patrones-Hermosos/commit/6f62add))
* 29 endpoints ([264aa10](https://github.com/iiRoy/Patrones-Hermosos/commit/264aa10))
* feature(database) Se agrego una nueva columna [status] a la tabla groups ([90774f2](https://github.com/iiRoy/Patrones-Hermosos/commit/90774f2))
* guardar cambios antes del merge ([05431fe](https://github.com/iiRoy/Patrones-Hermosos/commit/05431fe))
* Merge remote-tracking branch 'origin/main' into diego_sqlProcedures ([a060120](https://github.com/iiRoy/Patrones-Hermosos/commit/a060120))
* Merge remote-tracking branch 'origin/main' into diego_sqlProcedures ([4a271bd](https://github.com/iiRoy/Patrones-Hermosos/commit/4a271bd))
* Se añadieron nuevos triggers y funciones en after-migrate.sql, ademas de una nueva tabla llamada aud ([ddd3893](https://github.com/iiRoy/Patrones-Hermosos/commit/ddd3893))
