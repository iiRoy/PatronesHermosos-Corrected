...
router.put('/:id', upload.fields([
    { name: 'participation_file', maxCount: 1 },
    { name: 'logo', maxCount: 1 },
]), asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['admin']), venueValidator_1.validateVenue, venue_controller_1.default.update);
router.put('/basic/:id', asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['admin', 'superuser']), venue_controller_1.default.updateBasic);
router.delete('/:id', asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['admin']), venue_controller_1.default.remove);
router.post('/:id/cancel', asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['admin']), venue_controller_1.default.cancelVenue);
...
router.get('/files/:filename', asyncHandler(authMiddleware_1.authMiddleware), (req, res) => {
    ...
    promises_1.default.access(filePath)
        .then(() => {
...
// Cancelar una sede
router.patch('/:id/cancelar', asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['superuser']), venue_controller_1.default.cancelarVenue);
router.get('/:id/pdf', asyncHandler(authMiddleware_1.authMiddleware), venue_controller_1.default.getVenuePDF);
...
router.patch('/:id/approve', asyncHandler(authMiddleware_1.authMiddleware), venue_controller_1.default.approveVenue);
router.patch('/:id/reject', asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']), venue_controller_1.default.rejectVenue);
