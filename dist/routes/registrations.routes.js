...
router.get('/', asyncHandler(authMiddleware), roleMiddleware(['superuser', 'venue_coordinator']), async (req, res) => {
...
router.patch('/:id', asyncHandler(authMiddleware), roleMiddleware(['superuser', 'venue_coordinator']), async (req, res) => {
    const { id } = req.params;
