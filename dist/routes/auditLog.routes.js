...
router.get('/', asyncHandler(authMiddleware_1.authMiddleware), (0, authMiddleware_1.roleMiddleware)(['venue_coordinator', 'superuser']), auditlog_controller_1.default.getAll);
