...
router.get(
  ...
  superuser_controller_1.default.getAll,
);
router.post('/', superuserValidator_1.validateSuperUser, superuser_controller_1.default.create);
router.get(
  '/:id',
  asyncHandler(authMiddleware_1.authMiddleware),
  superuser_controller_1.default.getById,
);
router.put(
  '/:id',
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['admin']),
  superuserValidator_1.validateSuperUser,
  superuser_controller_1.default.update,
);
router.delete(
  '/:id',
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['admin']),
  superuser_controller_1.default.remove,
);
