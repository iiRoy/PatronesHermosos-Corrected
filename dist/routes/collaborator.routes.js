...
router.get(
  ...
  collaborator_controller_1.default.getAllCollaborators,
);
// Create a new collaborator (public, no auth required)
router.post(
  '/',
  collaboratorValidator_1.validateCollaborator,
  collaborator_controller_1.default.createCollaborator,
);
...
router.get(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.getCollaboratorById,
);
...
router.patch(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.rejectCollaborator,
);
...
router.put(
  ...
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaboratorValidator_1.validateCollaborator,
  collaborator_controller_1.default.updateCollaborator,
);
...
router.patch(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.updateCollaboratorBasicInfo,
);
...
router.delete(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.deleteCollaborator,
);
...
router.get(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.getAvailableGroups,
);
...
router.patch(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.approveCollaborator,
);
...
router.patch(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.cancelCollaborator,
);
...
router.patch(
  ...
  asyncHandler(authMiddleware_1.authMiddleware),
  (0, authMiddleware_1.roleMiddleware)(['superuser', 'venue_coordinator']),
  collaborator_controller_1.default.updateCollaboratorAssignment,
);
