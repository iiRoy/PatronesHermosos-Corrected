...
const create = async (req, res) => {
    ...
    const { name, country, state, address, venueCoordinator, associatedCoordinator, staffCoordinator, participantsCoordinator, } = parsedBody;
            ...
            try {
                ...
                await sendEmail({
                    ...
                    data: {
                        ...
                        venue: venue.name,
                        role: assistant.role === 'Coordinadora_de_informes'
