          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="texto-popup bg-white p-6 rounded-lg shadow-lg w-96 relative max-h-[80vh] overflow-y-auto text-gray-800">
              ...
              <div className="pt-6 pb-6">
                ...
                <p><strong>Apellido Paterno:</strong> {selectedMentora.paternal_name || 'No especificado'}</p>
                <p><strong>Apellido Materno:</strong> {selectedMentora.maternal_name || 'No especificado'}</p>
