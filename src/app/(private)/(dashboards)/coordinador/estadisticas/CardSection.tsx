    ...
    return (
        <div className='flex gap-3 flex-col items-center justify-center'>
            <div className='flex justify-between w-full items-center'>
                <div className='flex flex-col md:flex-row items-center justify-center w-full relative gap-2 md:gap-9'>
                    <div>
                        ...
                        <div
                            className={`md:ml-[4.4vw] flex items-center justify-center md:justify-start md:items-start text-[1.5vmax] text-text transition-opacity duration-300 ${fadeSec ? 'opacity-0' : 'opacity-100'
                                }`}
                        >
            ...
            <div className='w-full lg:w-4/7 flex flex-col'>
                <div
                    className={`flex flex-wrap gap-4 justify-between transition-opacity duration-300 ${fadeSec ? 'opacity-0' : 'opacity-100'
                        }`}
                >
                    {renderCards()}
                </div>
