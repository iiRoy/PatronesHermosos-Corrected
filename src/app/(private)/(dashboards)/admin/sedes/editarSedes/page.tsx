        ...
        <div className="p-6 pl-14 flex gap-4 flex-col text-primaryShade pagina-sedes relative">
            ...
            <div className="fondo-sedes flex flex-col p-6 gap-4 overflow-auto">
                ...
                <div className="flex gap-4 justify-between mb-4">
                    ...
                    <div>
                        <Button label="Datos de Sede" variant="warning" href="../../sedes/verSedes/verMonterrey" />
                    </div>
                </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                    <div className="fondo-agregar-participante bg-white p-8 rounded-lg shadow-lg relative w-full ">
                        ...
                        <h1 className="titulo-agregar-participante text-xl font-semibold mb-4 text-center">Agregar Participante</h1>
                        <p className='texto-agregar-participante text-center mb-4'>Participantes registradas en sede Monterrey</p>
