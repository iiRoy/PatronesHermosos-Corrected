            ...
            <div className="relative z-20 text-center contenido-inicio lg:basis-3/4">
              <div className='flex justify-end pb-16'>
                <h1 className="text-4xl mb-4 text-[#2E1C31] titulo-inicio text-end">
                  <span className='text-xl md:text-2xl lg:text-3xl italic'>¡Nos alegra verte en</span><br />
                  <span className='text-2xl md:text-3xl lg:text-4xl font-semibold'>Patrones Hermosos!</span>
                </h1>
