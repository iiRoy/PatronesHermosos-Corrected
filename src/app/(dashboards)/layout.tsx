...
export default function DashboardLayout({
    ...
    return (
        <div className='h-screen flex text-text bg-back'>
            {/*LEFT*/}
            <div className='w-[9%] md:w-[8%] lg:w-[17%] xl:w-[15%] overflow-y-auto overflow-x-hidden min-w-[8vh] max-h-screen flex flex-col justify-between bg-[#2E1C31] rounded-tr-[10px] rounded-br-[10px]'>
