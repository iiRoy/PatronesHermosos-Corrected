...
const ParticipantRegistrationForm: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.tutor.paternal_name)
      newErrors.push('El apellido paterno del tutor es obligatorio');
  ...
  return (
    <form
      className='pagina-formulario overflow-x-auto min-h-screen bg-gray-900 text-white flex flex-col items-center custom-scrollbar-tabla mt-8'
      ...
      <div className='info-formulario overflow-x-auto w-full max-w-6xl bg-gray-800 rounded-lg shadow-lg p-6 md:p-8 custom-scrollbar-tabla'>
        ...
        <div className='mt-12'>
          ...
          <p className='text-gray-400 text-sm md:text-base mb-4'>
            Responde con sinceridad las siguientes preguntas acerca de tus datos personales y de
            contacto. Las secciones que contienen un asterisco (*) deben de responderse de manera
            obligatoria.
          </p>
        </div>
        ...
        <div className='mt-12'>
          <h2 className='text-xl md:text-2xl font-semibold flex items-center mb-2'>
            <span className='mr-2'>
              <SealWarning width='1.5rem' height='1.5rem' fillColor='#ebe6eb' strokeWidth={0} />
            </span>{' '}
            Datos del Tutor
          </h2>
          <p className='text-gray-400 text-sm md:text-base mb-4'>
        ...
        <div className='mt-12'>
          <h2 className='text-xl md:text-2xl font-semibold flex items-center mb-2'>
            <span className='mr-2'>
              <Heart width='1.5rem' height='1.5rem' fillColor='#ebe6eb' strokeWidth={0} />
            </span>{' '}
            Permiso de Participación
          </h2>
          <p className='text-gray-400 text-sm md:text-base mb-4'>
            Dentro de esta sección tendrás que subir tu permiso de participación, la cual deberá de
            estar firmada por tu tutor. Esta sección es obligatoria.
          </p>

          {/* Download Section */}
          <div className='mb-6 flex items-center gap-4'>
            <p className='text-lg text-gray-400'>Descarga la convocatoria para psrticipantes:</p>
            <a
          ...
          <div className='tarjeta-archivo p-4 bg-white text-black rounded-lg'>
            <div className='flex items-center gap-4'>
              <div className='icono-tarjeta-archivo'>
                <FilePdfIcon width='2rem' height='2rem' strokeWidth={0} />
              </div>
            ...
            <p className='text-gray-700 my-8'>
              Selecciona un documento para subir. Ten cuidado al subir tus documentos y verifica dos
              veces que se suba correctamente.
            </p>
            <input
              type='file'
