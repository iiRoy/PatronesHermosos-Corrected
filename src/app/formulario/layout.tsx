    ...
    <div className='min-h-screen flex flex-col text-text bg-back'>
      ...
      <div className='w-[100%] relative'>
        ...
        <div className='sticky z-20 overflow-x-clip'>
          ...
          <div className='absolute top-[3vw] right-[7vw] w-[4vw] h-[4vw] bg-[#EBE6EB] rounded-full shadow-custom-dark'></div>
          <div className='absolute top-[2vw] right-[13vw] w-[2.5vw] h-[2.5vw] bg-[#EBE6EB] rounded-full shadow-custom-dark'></div>
        </div>
        {/* Contenido principal */}
