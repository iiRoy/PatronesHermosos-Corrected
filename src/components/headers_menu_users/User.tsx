            ...
            <div className='flex flex-col w-full gap-2'>
                <div className="px-1 flex items-center lg:ml-2 justify-center inline-block lg:justify-start pb-0">
                    <Link href={"/"} className="flex items-center justify-center gap-3 p-2">
                        ...
                        <div className='flex flex-col text-left hidden lg:block'>
                            <span className="text-sm leading-5 text-[1.5vmax]">María Patricia de los Ángeles</span>
                            <span className='text-[1.05vmax] font-medium text-textDim block break-all'>@username_example</span>
                        </div>
                    </Link>
                </div>
                <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center lg:justify-end pb-2 pr-1">
                    <Link href={"/"} className="w-auto h-auto flex items-center justify-center p-2 cursor-pointer relative">
                        ...
                        <div className='absolute transform w-[0.9vw] h-[0.9vw] md:min-w-[1.5vw] md:min-h-[1.5vw] min-w-[2vmax] min-h-[2vmax] top-0 right-0.5 p-1 pr-1.5 pl-1.5 flex items-center justify-center bg-purple-500 text-white rounded-full text-[clamp(0.5rem,1.0vw,2rem)]'>1</div>
                    </Link>
